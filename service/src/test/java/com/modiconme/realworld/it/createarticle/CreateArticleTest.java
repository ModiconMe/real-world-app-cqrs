...
import com.modiconme.realworld.domain.articlecreate.ArticleDto;
...
class CreateArticleTest extends SpringIntegrationTest {
    ...
    void success() {
        ...
        var expectedResponse = new CreateArticleResponse(new ArticleDto(
                request.title(),
                request.title(),
                request.description(),
                request.body(),
        ...
        RestResponseAssertion.assertThat(result)
                ...
                .hasDataEquals(expectedResponse)
                .hasErrorEquals(null);
        ...
        assertThat(tag2.get()).isEqualTo(existedTag);
    }
